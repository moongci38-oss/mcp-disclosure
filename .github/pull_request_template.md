<!-- =============================================================================
  ...
  Forge Dev 파이프라인 연계:
    - Phase 9 (PR 생성) 에서 AI가 이 템플릿을 기반으로 PR 본문 작성
    - "Spec Compliance Checklist" = Check 8.5 트레이서빌리티 검증 결과 반영
    - "Testing" = Check 8 (test/lint/build) 결과 반영
  ...
  Forge Dev pipeline integration:
    - In Phase 9 (PR creation), AI fills this template as PR body
    - "Spec Compliance Checklist" reflects Check 8.5 traceability results
    - "Testing" reflects Check 8 (test/lint/build) results
